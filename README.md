# Este é o README dos exercícios propostos no curso de Python 3 do Curso em Vídeo
...
## Neste caso, estarei resolvendo-os na linguagem Java

---

## Anotações importantes

- Anotações da aula 20, sobre funções (Parte 1) em Python: [notas.md](https://github.com/John1Souza/JavaExercises/blob/master/mundo_3/aula_20/notas.md)

- Anotações da aula 21, sobre funções (Parte 2) em Python: [notas.md](https://github.com/John1Souza/JavaExercises/blob/master/mundo_3/aula_21/notas.md)
